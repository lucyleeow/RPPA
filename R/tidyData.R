...
#' 
#' If the exact same sample name appears multiple times, they are technical 
#' replicates and can be averaged using 'ave_reps'. 
#' 
#' Full antibody names and phenotype information can also be merged into the 
#' base RFI dataframe.
#' 
